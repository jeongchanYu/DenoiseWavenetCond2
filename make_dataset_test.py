...
def make_dataset(train_source_path, train_target_path, batch_size, previous_size, frame_size, future_size, num_of_speaker, num_of_noise, shift_size=None, window_type='uniform', shuffle=True, default_float='float32'):
    if num_of_speaker < 2:
